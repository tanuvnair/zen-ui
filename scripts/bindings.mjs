...
export const BINDINGS = [
  ...
  },
  {
    ...
    divergent: [
      ...
      "NumberFieldHandle", "PopoverAlign", "PopoverAnchor", "PopoverContent", "PopoverHandle", "PopoverSide",
      "PopoverTrigger", "RatingSize", "SelectDialogHandle", "SelectableCard", "SelectableCardItemSpec", "SheetClose",
