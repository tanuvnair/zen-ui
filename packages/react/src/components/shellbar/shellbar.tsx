    ...
    const searchField = (
      <form role="search" className="zen-relative zen-flex zen-items-center" onSubmit={submitSearch}>
        ...
        <Icon
          name="search"
          size={14}
          className="zen-pointer-events-none zen-absolute zen-left-2 zen-text-zen-muted-fg"
        />
        <Input
          id={searchId}
          type="search"
              ...
              {notificationCount !== undefined || onNotificationsClick ? (
                <span className="zen-relative zen-flex zen-shrink-0">
                  ...
                  {notificationCount ? (
                    <span
                      aria-hidden="true"
                      className="zen-pointer-events-none zen-absolute -zen-right-1 -zen-top-1 zen-flex zen-h-4 zen-min-w-4 zen-items-center zen-justify-center zen-rounded-zen-full zen-bg-zen-error zen-px-1 zen-text-xs zen-font-semibold zen-leading-none zen-text-zen-error-fg"
                    >
