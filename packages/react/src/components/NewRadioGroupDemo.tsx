...
<RadioGroup value={plan} onValueChange={setPlan}>
  ...
  <label style={{ display: "flex", alignItems: "center", gap: 8 }}>
    ...
    <span>Team</span>
        ...
        >
          <RadioGroup value={plan} onValueChange={setPlan}>
            <label style={{ display: "flex", alignItems: "center", gap: 8, fontSize: "1.4rem" }}>
              <RadioGroupItem value="free" id="r-free" />
              <span>Free</span>
            </label>
            <label style={{ display: "flex", alignItems: "center", gap: 8, fontSize: "1.4rem" }}>
...
<RadioGroupItem size="lg" value="c" />`}
        >
          <RadioGroup defaultValue="b" style={{ display: "flex", flexDirection: "row", gap: "1.2rem" }}>
      ...
      <section className="demo-section">
        ...
        <CodeExample
          ...
          code={`<RadioGroup style={{ display: "flex", flexDirection: "row", gap: "1.6rem" }}>
  ...
</RadioGroup>`}
        >
          <RadioGroup
          ...
          >
            <label style={{ display: "inline-flex", alignItems: "center", gap: 6, fontSize: "1.4rem" }}>
      ...
      <section className="demo-section">
        ...
        >
          <RadioGroup defaultValue="a">
            ...
            <label style={{ display: "flex", alignItems: "center", gap: 8, fontSize: "1.4rem", color: "var(--zen-color-muted-fg)" }}>
        ...
        >
          ...
          >
            <RadioGroup
              name="priority"
              defaultValue="medium"
              style={{ display: "flex", flexDirection: "row", gap: "1.2rem" }}
            >
              <label style={{ display: "inline-flex", alignItems: "center", gap: 6, fontSize: "1.4rem" }}>
